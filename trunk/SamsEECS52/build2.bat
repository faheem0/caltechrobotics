...
echo ================================
link86 c0smrom.obj, mp3port.obj keypad.obj, display.obj, lib188.obj, fatutil.obj, ffrev.obj, IC86.lib, SCLIB.lib to lnk1.lnk
echo ================================
link86 lnk1.lnk, mainloop.obj, playmp3.obj, simide.obj, stubfncs.obj, keyupdat.obj, trakutil.obj to startup.lnk
echo ================================
