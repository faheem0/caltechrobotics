...
IC86 simide.c debug extend mod186 small optimize(0) rom
IC86 stubfncs.c debug extend mod186 small optimize(0) rom
IC86 trakutil.c debug extend mod186 small optimize(0) rom
echo ================================
link86 c0smrom.obj, keypad.obj, display.obj, lib188.obj, fatutil.obj, ffrev.obj, keyupdat.obj, IC86.lib, SCLIB.lib to lnk1.lnk
echo ================================
link86 lnk1.lnk, mainloop.obj, playmp3.obj, simide.obj, stubfncs.obj, trakutil.obj to startup.lnk
echo ================================
loc86 startup.lnk to starup noic ad(sm(code(0500h), data(4000h), stack(7000h)))
echo ================================
