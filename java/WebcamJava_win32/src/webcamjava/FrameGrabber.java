...
public class FrameGrabber extends Thread implements ControllerListener {
   ...
   *  is provided
   */
  public final static String DEFAULT_DEV_NAME =
    "vfw:Microsoft WDM Image Capture (Win32):0";
  public final static String DEFAULT_X_RES = "160";
  public final static String DEFAULT_Y_RES = "120";
  public final static String DEFAULT_DEPTH = "24";
   ...
   **/
  public FrameGrabber(String devName) throws FrameGrabberException {
   ...
   * @throws FrameGrabberException If we can't start up the camera
   **/
  public FrameGrabber(String videoPropFile, String devName) throws FrameGrabberException {
    setup(videoPropFile, devName);
  }
   ...
   * @throws FrameGrabberException If we can't start up the camera
   **/
  private void setup(String videoPropFile, String devName) throws FrameGrabberException {
    ...
    for (int i = 0; i < streams.length; i++) {
      /*  Use the first Stream that is YUVFormat (there should be only one  */
      if (streams[i].getFormat() instanceof YUVFormat) {
        camStream = streams[i];
